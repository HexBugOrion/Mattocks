...
import net.oriondev.mattocks.mattock.EnderiteMaterial;
import net.oriondev.mattocks.mattock.Mattock;

public class Mattocks implements ModInitializer {

	public static final Mattock ENDERITE_MATTOCK = new Mattock(7, -3, new EnderiteMaterial(), new Item.Settings().group(ItemGroup.TOOLS).fireproof());
	...
	public static final Mattock DIAMOND_MATTOCK = new Mattock(5, -3, ToolMaterials.DIAMOND, new Item.Settings().group(ItemGroup.TOOLS));
	public static final Mattock IRON_MATTOCK = new Mattock(4, -3, ToolMaterials.IRON, new Item.Settings().group(ItemGroup.TOOLS));
